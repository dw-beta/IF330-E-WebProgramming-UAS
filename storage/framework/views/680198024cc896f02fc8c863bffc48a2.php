...
<body>
    ...
    <div class="judul">
        <img style="width: 50%" src="<?php echo e(asset('images/home/logosdit.png')); ?>">
    </div>
    <div class="about">
    ...
    <div class="isiabout">
        ...
        <img src="<?php echo e(asset('images/home/about.jpg')); ?>">
    </div>
    <div class="visi-misi">
    ...
    <div class="programunggulan">
        <div class="column">
            <div class="card" style="background-color: rgba(255, 216, 117, 0.60); border-radius: 120px;">
                <img src="<?php echo e(asset('images/home/kurikulum.png')); ?>">
                <h4>KURIKULUM<br /><br /><br /></h4>
            </div>
        </div>
        <div class="column">
            <div class="card" style="background-color: #FFFACD; border-radius: 120px;">
                <img src="<?php echo e(asset('images/home/guru.png')); ?>">
    ...
    <div class="programunggulan">
        <div class="column">
            <div class="card" style="background-color: #FFFACD; border-radius: 120px;">
                <img src="<?php echo e(asset('images/home/metode.png')); ?>">
                <h4>METODE PEMBELAJARAN<br /><br /></h4>
            </div>
        </div>
        <div class="column">
            <div class="card" style="background-color: rgba(255, 216, 117, 0.60); border-radius: 120px;">
                <img src="<?php echo e(asset('images/home/fasilitas.png')); ?>">
...
</html><?php /**PATH C:\Users\user\Documents\KULIAH\SEMESTER 3\WebProg\UAS\webprog-uas\resources\views/home.blade.php ENDPATH**/ ?>