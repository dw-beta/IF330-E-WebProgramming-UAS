...
<body>
    ...
    <div class="gambaralur">
        <img src="<?php echo e(asset('images/ppdb/Alur_pendaftaran_ppdb.png')); ?>">
    </div>
    <div class="ppdb">
    ...
    <form action="<?php echo e(route('submit.registration')); ?>" method="post" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <div class="daftar">
...
</html><?php /**PATH C:\Users\user\Documents\KULIAH\SEMESTER 3\WebProg\UAS\webprog-uas\resources\views/ppdb.blade.php ENDPATH**/ ?>