...
<body>
    ...
    <div class="kartukegiatan">
        <div class="column">
            <div class="card" style="background-color: rgba(255, 216, 117, 0.60);">
                <img src="<?php echo e(asset('images/keagamaan/sholat_1.png')); ?>">
                <h4>Rutinitas Sholat<br /><br /></h4>
            </div>
        </div>
        <div class="column">
            <div class="card" style="background-color: #FFFACD;">
                <img src="<?php echo e(asset('images/keagamaan/sholat_2.png')); ?>">
                <h4>Rutinitas Sholat<br /><br /></h4>
            </div>
        </div>
        <div class="column">
    ...
    <div class="kartukegiatan">
        <div class="column">
            <div class="card" style="background-color: #FFFACD;">
                <img src="<?php echo e(asset('images/keagamaan/murojaah.png')); ?>">
    ...
    <div class="kartuekstra">
        <div class="column">
            <div class="card" style="background-color: rgba(255, 216, 117, 0.60);">
                <br /><img src="<?php echo e(asset('images/ekskul/bahasajerman.png')); ?>">
                <h4><br />Bahasa Jerman<br /><br /></h4>
            </div>
        </div>
        <div class="column">
            <div class="card" style="background-color: #FFFACD;">
                <img src="<?php echo e(asset('images/ekskul/kaligrafi.png')); ?>">
                <h4>Kaligrafi<br /><br /></h4>
            </div>
        </div>
        <div class="column">
            <div class="card" style="background-color: rgba(255, 216, 117, 0.60);">
                <img src="<?php echo e(asset('images/ekskul/marawis.png')); ?>">
                <h4>Marawis<br /><br /></h4>
            </div>
        </div>
    </div>
    <div class="kartuekstra">
        <div class="column">
            <div class="card" style="background-color: #FFFACD;">
                <img src="<?php echo e(asset('images/ekskul/literasi.png')); ?>">
                <h4>Pengembangan <br />Literasi<br /></h4>
            </div>
        </div>
        <div class="column">
            <div class="card" style="background-color: rgba(255, 216, 117, 0.60);">
                <img src="<?php echo e(asset('images/ekskul/lukis.png')); ?>">
                <h4>Seni Lukis<br /><br /></h4>
            </div>
        </div>
        <div class="column">
            <div class="card" style="background-color: #FFFACD;">
                <img src="<?php echo e(asset('images/ekskul/pramuka.png')); ?>">
                <h4>Pramuka<br /><br /></h4>
            </div>
        </div>
    </div>
    <div class="kartuekstra">
        <div class="column">
            <div class="card" style="background-color: rgba(255, 216, 117, 0.60);">
                <img src="<?php echo e(asset('images/ekskul/silat.png')); ?>">
                <h4>Pencak Silat<br /><br /></h4>
            </div>
        </div>
        <div class="column">
            <div class="card" style="background-color: #FFFACD;">
                <img src="<?php echo e(asset('images/ekskul/taekwondo.png')); ?>">
                <h4>Taekwondo<br /><br /></h4>
            </div>
        </div>
        <div class="column">
            <div class="card" style="background-color: rgba(255, 216, 117, 0.60);">
                <img src="<?php echo e(asset('images/ekskul/panahan.png')); ?>">
                <h4>Panahan<br /><br /></h4>
            </div>
        </div>
    </div>
    <div class="kartuekstra">
        <div class="column">
            <div class="card" style="background-color: #FFFACD;">
                <img src="<?php echo e(asset('images/ekskul/renang.png')); ?>">
                <h4>Renang<br /><br /></h4>
            </div>
        </div>
    </div>
...
</html><?php /**PATH C:\Users\user\Documents\KULIAH\SEMESTER 3\WebProg\UAS\webprog-uas\resources\views/kegiatan.blade.php ENDPATH**/ ?>